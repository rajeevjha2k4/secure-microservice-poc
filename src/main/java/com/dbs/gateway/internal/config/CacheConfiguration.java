...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("securemicroservicepoc");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("securemicroservicepoc");
        ...
        config.getMapConfigs().put("com.dbs.gateway.internal.domain.*", initializeDomainMapConfig(jHipsterProperties));
